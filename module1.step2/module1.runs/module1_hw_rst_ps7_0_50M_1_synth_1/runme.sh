...
HD_PWD='/thayerfs/home/f0041yr/workspace/module1/module1.runs/module1_hw_rst_ps7_0_50M_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log module1_hw_rst_ps7_0_50M_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source module1_hw_rst_ps7_0_50M_1.tcl
